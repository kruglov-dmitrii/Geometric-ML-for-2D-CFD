...
Our target is to develop an ML algorithm which for a given CFD domain, a given cylinder, and a given mesh, predicts the relevant $(u,v,p)$ (time-dependent) field quantities at each mesh node. The desired outcome is something like: https://drive.google.com/file/d/1tHdQvCbvCvDpkXEGaDgWqgLknotfDNpE/view
